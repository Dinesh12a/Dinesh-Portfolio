...
var typed = new Typed('#element', {
    strings: ['Front-End Developer', 'Web Designer', 'Python Developer', 'Java Developer', 'Data Analyst'],
    typeSpeed: 90,
    loop: true,
});
...
ScrollReveal().reveal(
  ".home-container .button-1, .box, .profile-picture, .about-image, .form-content h1, .form-content p, .education, .certifi-1",
  {
    origin: "left",
  }
);
